...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [529870.413907, 5452911.327040, 542752.148584, 5461107.041468], maxZoom: 17, minZoom: 1
    })
});


map.getView().fit([529870.413907, 5452911.327040, 542752.148584, 5461107.041468], map.getSize());
